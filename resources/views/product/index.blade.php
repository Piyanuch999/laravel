    ...
    <table class="table table-bordered bs-table">
        ...
        <tbody>
            @foreach ($products as $p)
                <tr>
                    <td><img src="{{ $p->image_url}}" width="50px" alt=""></td>
                    <td> {{ $p->code }}</td>
                    <td> {{ $p->name }}</td>
                    ...
                    <td class="bs-center">
                        <a href="{{ URL::to('product/edit/'.$p->id) }}" class="btn btn-info"><i class="fas fa-edit"></i>แก้ไข</a>
                        <a href="#" class="btn btn-danger btn-delete" id-delete="{{ $p->id }}"><i class="fas fa-trash"></i>ลบ</a>
                    </td>
                </tr>
                @endforeach                         
        </tbody>                
